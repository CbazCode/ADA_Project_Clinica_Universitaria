...
public class editaPaciente extends javax.swing.JDialog {
    int DniAnterior;
    ...
    int indexEstadoCivilPaciente(String texto){
        int index=0;
        if("Soltero".equals(texto)) return 1;
        if("Casado".equals(texto)) return 2;
        if("Viudo".equals(texto)) return 3;
        if("Divorciado".equals(texto)) return 4;
        
        return index;
    }
    int indexGeneroPaciente(String texto){
        int index=0;
        
        if("Femenino".equals(texto)) return 1;
        if("Masculino".equals(texto)) return 2;

        return index;
    }
    int indexSeguroPaciente(String texto){
        int index=0;
        if("No tengo".equals(texto)) return 1;
        if("Tengo".equals(texto)) return 2;
    ...
    public static Date ParseFecha(String fecha)
    {
        ...
        Date convertidoDate = null;
        try {
            convertidoDate = formato.parse(fecha);
        } 
        catch (ParseException ex) 
        {
            System.out.println(ex);
        }
        return convertidoDate;
    }
    
    public void recibeDatos(Paciente paciente){
        DniAnterior = paciente.getDni();
        
        tDNI.setText(String.valueOf(paciente.getDni()));
        tNombre.setText(paciente.getNombre());
        tApellidoP.setText(paciente.getApellidoPaterno());
        tApellidoM.setText(paciente.getApellidoMaterno());
        tTelefono.setText(String.valueOf(paciente.getTelefono()));
        jComboEstadoCivil.setSelectedIndex(indexEstadoCivilPaciente(paciente.getEstadoCivil()));
    ...
    public void modificar(){
        ...
        File fileNuevo = new File("src/archivos/pacientestemp.txt");
        File fileAntiguo = new File("src/archivos/paciente.txt");
        BufferedReader br;
    ...
    public void modificar1(){
        ...
        File  fileAntiguo= new File("src/archivos/pacientestemp.txt");
        File  fileNuevo= new File("src/archivos/paciente.txt");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editaPaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                editaPaciente dialog = new editaPaciente(new javax.swing.JFrame(), true);
