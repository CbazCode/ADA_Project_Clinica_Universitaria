...
public class medicoMain extends javax.swing.JFrame {
    ...
    private void completarTabla(){
        ...
        modelo.addColumn("Centro medico");
    ...
    private void initComponents() {
        ...
        comboFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "DNI", "Nombre", "Apellido paterno", "Apellido materno","Centro médico","Especialidad" }));
    ...
    private void textBuscadorKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textBuscadorKeyTyped
        ...
        if(comboFiltro.getSelectedIndex()==4){
            textBuscador.addKeyListener(new KeyAdapter() {
                public void keyReleased(KeyEvent ke){
                    trs.setRowFilter(RowFilter.regexFilter("(?i)"+textBuscador.getText(), 6));
                }
            });
            trs =new TableRowSorter(modelo);
            tablaTest.setRowSorter(trs);
    ...
    private void bNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bNuevoActionPerformed
        ...
        nuevoMedico cc= new nuevoMedico(this,true);
        cc.setVisible(true);
        if(!cc.isVisible()){
            completarDatos();
        }
    ...
    private void bEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEditarActionPerformed
        ...
        try{
            ...
            if (filaseleccionada==-1){
                ...
                int dniMedico = Integer.parseInt((String) tablaTest.getValueAt(filaseleccionada, 0));
                String nombreMedico = (String)tablaTest.getValueAt(filaseleccionada, 1);
                String apellidoPaternoMedico = (String)tablaTest.getValueAt(filaseleccionada, 2);
                String apellidoMaternoMedico =(String)tablaTest.getValueAt(filaseleccionada, 3) ;
                int telefonoMedico = Integer.parseInt((String) tablaTest.getValueAt(filaseleccionada, 4));
                String correoElectronicoMedico = (String)tablaTest.getValueAt(filaseleccionada, 5);
                String centroDeEstudioMedico = (String)tablaTest.getValueAt(filaseleccionada, 6) ;
                String especialidadMedico = (String)tablaTest.getValueAt(filaseleccionada, 7);
                
                Medico medico = new Medico(dniMedico, nombreMedico, apellidoPaternoMedico, apellidoMaternoMedico, telefonoMedico, correoElectronicoMedico, centroDeEstudioMedico, especialidadMedico);
                
                editaMedico ec= new editaMedico(this,true);
                ec.recibeDatos(medico);
                ec.setVisible(true);
                if(!ec.isVisible()){
                    completarDatos();
