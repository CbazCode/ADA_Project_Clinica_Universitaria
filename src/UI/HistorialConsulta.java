...
public class HistorialConsulta extends javax.swing.JFrame {
    ...
    private void completarTabla() {
        ...
        header2.setDefaultRenderer(new HistorialConsulta.HeaderRenderer(tablaConsulta));
    ...
    protected void leerArchivo(String id) {
        ...
        FileReader fr = null;
        BufferedReader br;
        file = new File("src/archivos/consulta.txt");
        if (!file.exists()) {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jScrolTest2, javax.swing.GroupLayout.DEFAULT_SIZE, 380, Short.MAX_VALUE)
                .addContainerGap())
