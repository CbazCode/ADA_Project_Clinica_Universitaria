...
public class pacienteMain extends javax.swing.JFrame {
    ...
    private void completarTabla(){
        ...
        columnModel.getColumn(9).setPreferredWidth(500);
    ...
    private void initComponents() {
        ...
        comboFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "DNI", "Apellido paterno", "Apellido materno", "Nombre","Estado civl","Género","Fecha","Telefono","Seguro"}));
    ...
    private void bNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bNuevoActionPerformed
        ...
        nuevoPaciente nuevo= new nuevoPaciente(this,true);
    ...
    private void bEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEditarActionPerformed
        ...
        try{
            ...
            if (filaseleccionada==-1){
                ...
                int dniPaciente = Integer.parseInt((String) tablaTest.getValueAt(filaseleccionada, 0));
                String apellidoPaternoPaciente = (String)tablaTest.getValueAt(filaseleccionada, 1);
                String apellidoMaternoPaciente =(String)tablaTest.getValueAt(filaseleccionada, 2) ;
                String nombrePaciente = (String)tablaTest.getValueAt(filaseleccionada, 3);
                String estadoCivilPaciente = (String)tablaTest.getValueAt(filaseleccionada, 4);
                String generoPaciente =  (String)tablaTest.getValueAt(filaseleccionada, 5);
                //SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
                 
                String fecha = (String)tablaTest.getValueAt(filaseleccionada, 6);
                int telefonoPaciente = Integer.parseInt((String) tablaTest.getValueAt(filaseleccionada, 7));
                String seguroPaciente = (String)tablaTest.getValueAt(filaseleccionada, 8);
                String problemasMedicos = (String)tablaTest.getValueAt(filaseleccionada, 9);
                
                Paciente paciente = new Paciente(apellidoPaternoPaciente,apellidoMaternoPaciente,nombrePaciente,estadoCivilPaciente,
                    generoPaciente,dniPaciente,telefonoPaciente,seguroPaciente,problemasMedicos,fecha);
                
                editaPaciente ep= new editaPaciente(this,true);
                ep.recibeDatos(paciente);
                ep.setVisible(true);
                if(!ep.isVisible()){
                    completarDatos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pacienteMain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pacienteMain().setVisible(true);
            }
        });
    }
