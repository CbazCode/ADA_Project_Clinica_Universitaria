...
public class recetaMain extends javax.swing.JFrame {
    ...
    private void leerArchivo() {
       ...
       try{
           file = new File("src/archivos/recetas.txt");
    ...
    private void initComponents() {
        ...
        comboFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Codigo", "Medicamentos", "Instrucciones"}));
    ...
    private void bNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bNuevoActionPerformed
        ...
        nuevaReceta cc= new nuevaReceta(this,true);
        cc.setVisible(true);
        if(!cc.isVisible()){
            completarDatos();
        }
    ...
    private void bEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEditarActionPerformed
        ...
        try{
            ...
            if (filaseleccionada==-1){
                ...
                String Medicamentos = (String)tablaTest.getValueAt(filaseleccionada, 1);
                String Instrucciones = (String)tablaTest.getValueAt(filaseleccionada, 2);
                
                
                Receta receta = new Receta(codigoCita, Medicamentos,Instrucciones);
                
                editaReceta ec= new editaReceta(this,true);
                ec.recibeDatos(receta);
                ec.setVisible(true);
                if(!ec.isVisible()){
                    completarDatos();
