...
public class nuevoMedico extends javax.swing.JDialog {
     ...
     */
    public nuevoMedico(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    void escribir(){
        File file = new File("src/archivos/medicos.txt");
    ...
    private void bGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bGrabarActionPerformed
        if(!tNombre.getText().isEmpty() &&
                !tApellidoP.getText().isEmpty() &&   
                !tApellidoM.getText().isEmpty() &&  
                !tTelefono.getText().isEmpty() &&  
                !tCorreo.getText().isEmpty() &&  
                !tDNI.getText().isEmpty() &&
                !tCentroMedico.getText().isEmpty() &&  
