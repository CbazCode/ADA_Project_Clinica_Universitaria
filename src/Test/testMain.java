...
public class testMain extends javax.swing.JFrame {
    ...
    public void completarDatos(){
        modelo.setRowCount(0);
        //Aca llenas la tabla con el archivo .txt / fill
        /*
        While lee archivo 
            Object [] fila = new Object[NUMDECOLUMNS];
            for(i=0; i<NUMDECOLUMNS,I++){
                fila[i] = DATO DE ARCHIVO(columna i);
            }
            //modelo.addRow(FILA)
        */
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(textBuscador)
                .addGap(18, 18, 18)
                .addComponent(jLabel2)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(comboFiltro, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(26, 26, 26))
        );
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jScrolTest, javax.swing.GroupLayout.PREFERRED_SIZE, 858, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(29, 29, 29))
        );
    ...
    private void bNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bNuevoActionPerformed
        nuevoTest cc= new nuevoTest(this,true);
        cc.setVisible(true);
        if(!cc.isVisible()){
            completarDatos();
        }
    ...
    private void bEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEditarActionPerformed
        ...
        try{
            ...
            if (filaseleccionada==-1){
                ...
                String ruc = (String)tablaTest.getValueAt(filaseleccionada, 0);
                String razon = (String)tablaTest.getValueAt(filaseleccionada, 1);
                
                editaTest ec= new editaTest(this,true);
                ec.recibeDatos(ruc,razon);
                ec.setVisible(true);
                if(!ec.isVisible()){
                    completarDatos();
